			...
			?>
				...
				<form class="form-horizontal"  action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" method="post">
					...
					<td><select class="form-control input-sm" name="status" required>
						    ...
						    <option value="4">GURU AKTIF</option>
					...
					<td><select class="form-control input-sm"  name="bidang" required>
			 				...
			 				<option value="Bahasa Asing(Jepang)">Bahasa Asing(Jepang)</option>
		    			</select>
					</td>
					</tr>
					<tr colspan="3">
					 ...
					 <a href="admin3.php" class="btn btn-danger btn-sm" id="batal">BATAL</a>	
					 </td>
					 <td></td>
					 <td></td>
					</tr>

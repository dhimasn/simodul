...
<body>
	...
	<section>
			...
			<div class="panel panel-default" >
				...
				<span class="glyphicon glyphicon-th"></span> DAFTAR USER
					...
					<div class="list-group">
						<a href="admin1.php" class="list-group-item active">
		...
		<div class="col-sm-9">
			<div class="panel panel-default">
				<div class="panel-heading">
					<span class="glyphicon glyphicon-book"></span>&nbsp;&nbsp; DATA GURU MIA</div>
						<div class="panel-body">
						<p>
						<a href="add1.php" button class="btn btn-info btn-sm" id="btnTambahtugas">TAMBAH DATA GURU MIA</a></p>	
            ...
            <?php
			$sql = mysqli_query($koneksi, "SELECT * FROM guru WHERE Perminatan ='MIA' ORDER BY nip ASC");
			if(mysqli_num_rows($sql) > 0){
				...
				while($row = mysqli_fetch_assoc($sql)){
						...
						echo '
							...
							<td>
								<a href="profile1.php?nip='.$row['nip'].'"><button type="button" class="btn btn-primary" aria-label="user"><span class="glyphicon glyphicon-user" aria-hidden="true"></span></button>
								</a>
								<a href="edit1.php?nip='.$row['nip'].'"><button type="button" class="btn btn-success" aria-label="edit"><span class="glyphicon glyphicon-list" aria-hidden="ture"></span></button>
								</a>
								...
								<a href="admin1.php?aksi=delete&nip='.$row['nip'].'"onclick="return confirm(\'Yakin?\')"><button type="button" class="btn btn-danger" aria-label="delete"><span class="glyphicon glyphicon-trash" aria-hidden="true"></span></button></a>
							</td>
						</tr>
						';
						$no++;

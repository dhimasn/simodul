		...
		<section>
 		<div class="col-sm-3">
				 	<div class="panel panel-default" >
				 		<div class="panel-heading">
								...
								<div class="list-group">
									...
									<a href="admin3.php" class="list-group-item">
									...
									<a href="admin2.php" class="list-group-item active">
				...
				<div class="col-sm-9">
					<div class="panel panel-default">
						<div class="panel-heading">
							<span class="glyphicon glyphicon-book"></span>&nbsp;&nbsp; DATA SISWA MIS</div>
							<div class="panel-body">
							<p><a href="add2.php" button class="btn btn-info btn-sm" id="btnTambahtugas">TAMBAH DATA SISWA MIS</a>	
			...
			?>
					<thead>
                      ...
                      <?php
				$sql = mysqli_query($koneksi, "SELECT * FROM siswa WHERE Perminatan ='MIS' ORDER BY nis ASC");
				if(mysqli_num_rows($sql) > 0){
					...
					while($row = mysqli_fetch_assoc($sql)){
						...
						echo '
							...
							<td>
								<a href="profile2.php?nis='.$row['nis'].'"><button type="button" class="btn btn-primary" aria-label="user"><span class="glyphicon glyphicon-user" aria-hidden="true"></span></button>
								</a>
								<a href="edit2.php?nis='.$row['nis'].'"><button type="button" class="btn btn-success" aria-label="edit"><span class="glyphicon glyphicon-list" aria-hidden="ture"></span></button>
								</a>
								<a href="password.php?nis='.$row['nis'].'"><button type="button" class="btn btn-warning" aria-label="password"><span class="glyphicon glyphicon-wrench" aria-hidden="true"></span></button>
								</a>
								<a href="admin2.php?aksi=delete&nis='.$row['nis'].'"onclick="return confirm(\'Yakin?\')"><button type="button" class="btn btn-danger" aria-label="delete"><span class="glyphicon glyphicon-trash" aria-hidden="true"></span></button></a>
							</td>
						</tr>
						';
						$no++;

...
<section> 
		<div class="container-fluid">
				...
				<div class="col-sm-5 col-sm-offset-3">
					<div class="panel panel-default">
						<div class="panel-heading">
							<span class="glyphicon glyphicon-book"></span>&nbsp;&nbsp;EDIT GURU MIA</div>
			...
			if(isset($_POST['save'])){
				...
				if($update){
					header("Location: edit1.php?nip=".$nip."&pesan=sukses");
				}else{
			...
			?>
				...
				<form class="form-horizontal" method="post">
					...
					<td><select name="status" class="form-control" value="<?php echo $row['status']; ?>" required>
							...
							<option value="3" <?php if($row['status'] == '3'){ echo 'selected'; } ?>>GURU MIA AKTIF</option>
					...
					<td><select class="form-control input-sm"  name="bidang" required value="<?php echo $row['bidang']; ?>" >
			 				...
			 				<option value="Pendidikan agam dan Budi pekerti">Pendidikan agama dan Budi pekerti</option>
			 				<option value="Pendidikan pancasil dan Kewarganegaraan">Pendidikan pancasila dan Kewarganegaraan</option>
					...
					<tr colspan="2">
					 ...
					 <a href="admin1.php" class="btn btn-danger btn-sm" >BATAL</a></td>
					</tr>
			</form>
	 		</table>
												</div>

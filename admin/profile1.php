...
<section> 
				...
				<div class="col-sm-5 col-sm-offset-3">
					<div class="panel panel-default">
						<div class="panel-heading">
							<span class="glyphicon glyphicon-book"></span>&nbsp;&nbsp;PROFIL GURU MIA</div>
			...
			<a href="edit1.php?nip=<?php echo $row['nip']; ?>" class="btn btn-warning btn-sm" >RUBAH</a>
			<a href="profile1.php?aksi=delete&nip=<?php echo $row['nip']; ?>" class="btn btn-danger btn-sm">HAPUS</a>
												</div>
											</div>
										</div>
									</div>

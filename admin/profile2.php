...
<section> 
			...
			<a href="edit2.php?nis=<?php echo $row['nis']; ?>" class="btn btn-warning btn-sm" >RUBAH</a>
			<a href="profile2.php?aksi=delete&nis=<?php echo $row['nis']; ?>" class="btn btn-danger btn-sm">HAPUS</a>
												</div>
											</div>
										</div>
									</div>

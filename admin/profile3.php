...
<section> 
			...
			<a href="edit3.php?nis=<?php echo $row['nip']; ?>" class="btn btn-warning btn-sm" >RUBAH</a>
			<a href="profile3.php?aksi=delete&nip=<?php echo $row['nip']; ?>" class="btn btn-danger btn-sm">HAPUS</a>
												</div>
											</div>
										</div>
									</div>

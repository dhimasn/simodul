					...
					<div class="row">
						<div class="col-sm-12">
							<div class="panel panel-default">
								...
								<h2 align="center">Data Pengirim Tugas</h2>
								...
								<thead>
									<tr>
										...
										<th>tipe file</th>
										<th>ukuran file</th>
										<th>Tanggal Upload</div></th>
										<th>Aksi</th>
									</tr>
								</thead>
										<?php
										$a = $_GET['id'];
										$sql = mysqli_query($koneksi ,"SELECT * FROM tugasupload WHERE idtugas = '$a' && minat='MIA'");
										...
										echo '<tr bgcolor="#fff">
												...
												<a href="'.$data['file'].'" class="btn btn-success" role="button">Download</a></td>

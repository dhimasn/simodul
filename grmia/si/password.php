...
<section> 
		<div class="container-fluid">
				...
				<div class="col-sm-6 col-sm-offset-3">
					<div class="panel panel-default">
						<div class="panel-heading">
							<span class="glyphicon glyphicon-book"></span>&nbsp;&nbsp;RUBAH PASSWORD</div>
			...
			if(isset($_POST['ganti'])){
				...
				$cek = mysqli_query($koneksi, "SELECT * FROM guru WHERE nip='$nip' AND password='$password'");
				if(mysqli_num_rows($cek) == 0){
					...
					if($password1 == $password2){
						if(strlen($password1) >= 5){
							$pass = md5($password1);
							$update = mysqli_query($koneksi, "UPDATE guru SET password='$pass' WHERE nip='$nip'");
							if($update){
			...
			?>
				...
				<form class="form-horizontal" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" method="post">
					<tr>
					 ...
					 <td>:</td>
					 <td><input type="password" name="password" class="form-control" placeholder="PASSWORD SEKARANG"></td>
					</tr>
					<tr>
					 <td>PASSWORD BARU</td>
					 <td>:</td>
					...
					<td>KONFIRMASI PASSWORD BARU</td>
					 ...
					 <tr colspan="2">
					 <td><input type="submit" name="ganti" value="RUBAH" class="btn btn-danger btn-sm">

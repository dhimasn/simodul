				...
				<div class="container-fluid">
					<div class="row">		
 							...
 							<div class="panel panel-default">
				  			...
				  			<div class="panel panel-default" >
								...
								<div class="list-group">
									...
									<a  href="ipa.php" class="list-group-item active">
						...
						<div class="panel-body">
						  ...
						  <li role="presentation" ><a href="ipa.php">MODUL PELAJARAN</a></li>
						  <li role="presentation" class="active"><a href="soal.php">LATIHAN SOAL</a></li>
								...
								<thead>
									...
									<?php
										$sql = mysqli_query($koneksi , " SELECT * FROM materi WHERE tipe!='MODUL PELAJARAN' && matapel='Sejarah Indonesia' && minat='MIA'");

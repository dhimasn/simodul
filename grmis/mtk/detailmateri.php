					...
					<div class="row">
						<div class="col-sm-6 col-sm-offset-3">
							<div class="panel panel-default">
								...
								<h1 align="center">DETAIL MATERI</h1>       
        <form class="form-horizontal"  method="post" enctype="multipart/form-data" action="">
			<div class="form-group form-group-sm">
			<label class="col-sm-6 control-label pad-right-zero">Nama File :</label>
			<div class="col-sm-5">
				<?php echo $data['nama_file']?>
			</div>
			</div>
			<div class="form-group form-group-sm">
			<label class="col-sm-6 control-label pad-right-zero">Kelas :</label>
			<div class="col-sm-5">
				<?php echo $data['kelas']?>
			</div>
			</div>
			<div class="form-group form-group-sm">
			<label class="col-sm-6 control-label pad-right-zero">Tahun :</label>
			<div class="col-sm-5">
				<?php echo $data['Tahun']?>
			</div>
			</div>
			<div class="form-group form-group-sm">
			<label class="col-sm-6 control-label pad-right-zero">Tanggal unggah :</label>
			<div class="col-sm-5">
				<?php echo $data['tanggal_upload']?>
			</div>
			</div>
			<div class="form-group form-group-sm">
			<label class="col-sm-6 control-label pad-right-zero">Tipe Modul :</label>
			<div class="col-sm-5">
				<?php echo $data['tipe']?>
				</div>
			</div>
			<div class="form-group form-group-sm">
			<label class="col-sm-6 control-label pad-right-zero">Ukuran file :</label>
			<div class="col-sm-5">
					<?php echo $data['ukuran_file']?>
			</div>
			</div>
			<div class="form-group form-group-sm">
			<label class="col-sm-6 control-label pad-right-zero">Mata pelajaran :</label>
			<div class="col-sm-5">
					<?php echo $data['matapel']?>
			</div>
			</div>
			<div class="form-group form-group-sm">
			<div class="col-sm-8 col-sm-offset-5" > 
			<a href="<?php echo $data['file']?>" class="btn btn-success btn-sm" role="button">UNDUH</a>
			</div>
			</div>
		</form>
        				</div>

  	...
  	<header>
			...
			<section> 
				<div class="container-fluid">
				  ...
				  <div class="panel-body">
						  ...
						  <li role="presentation" class="active"><a href="ips.php">MODUL PELAJARAN</a></li>
						  <li role="presentation"><a href="soal.php">LATIHAN SOAL</a></li>
								</ul>
								<br>
								<div class="panel panel-default" >
								<div class="panel-heading">
        ...
        <table id="example1" class="table table-bordered table-striped">
                    			...
                    			<th>Aksi</th>
									...
									<?php
										$sql = mysqli_query($koneksi , " SELECT * FROM materi WHERE tipe='MODUL PELAJARAN' && matapel='Sejarah Indonesia' && minat='MIS'");

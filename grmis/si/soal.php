  	...
  	<header>
					...
					<div class="row">
				  		...
				  		<div class="panel panel-default" >
								...
								<div class="list-group">
									...
									<a  href="ips.php" class="list-group-item active">
							...
							<div class="panel panel-default">
				  				<div class="panel-body">
									<ul class="nav nav-tabs">
						  				<li role="presentation"><a href="ips.php">MODUL PELAJARAN</a></li>
						  				<li role="presentation" class="active"><a href="soal.php">LATIHAN SOAL</a></li>
									</ul>
									<br>
										<div class="panel panel-default">
										<div class="panel-heading">
										<span class="glyphicon glyphicon-book"></span>&nbsp;&nbsp;LATIHAN SOAL</div>
												<div class="panel-body">
												<p><a href="uploadmateri.php"  class="btn btn-info btn-sm">Tambah Data</a></p>
        ...
        <table id="example1" class="table table-bordered table-striped">
								<thead>
									   	 ...
									   	 <?php
				//include('../config.php');
				$sql = "SELECT * FROM materi WHERE tipe!='MODUL PELAJARAN' && matapel='Sejarah Indonesia' && minat='MIS' ";
					...
					while($data = mysqli_fetch_assoc($result)){
						...
						<tr bgcolor="#fff">
							...
							<td>						
							  					...
							  					<a href="hapusmateri.php?id='.$data['id'].'"  onclick="return confirm(\'Yakin?\')"><button type="button" class="btn btn-danger btn-sm" aria-label="delete"><span class="glyphicon glyphicon-trash" aria-hidden="true"></span></button></a>

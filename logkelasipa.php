				  ...
				  <div class="panel panel-default" >
						...
						<div class="list-group">
									<a data-toggle="modal" href="#myModal" class="list-group-item">
										<span class="glyphicon glyphicon-file"></span> KELAS 10 MIA
									</a>
									<a data-toggle="modal" href="#myModal" class="list-group-item">
										<span class="glyphicon glyphicon-file"></span> KELAS 11 MIA
									</a>
									<a data-toggle="modal" href="#myModal" class="list-group-item">
										<span class="glyphicon glyphicon-file"></span> KELAS 12 MIA
									</a>
									</div>
								</div>
							</div>

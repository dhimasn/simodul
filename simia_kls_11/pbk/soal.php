...
<div class="col-sm-4">
				  ...
				  <div class="panel panel-default" >
						...
						<div class="list-group">
									...
									<a href="../pbk/ipa.php" class="list-group-item active">
		...
		<table id="example1" class="table table-bordered table-striped">
									...
									<?php
										...
										$sql = mysqli_query($koneksi ,"SELECT * FROM materi WHERE tipe!='MODUL PELAJARAN' && matapel='Prakarya Budidaya dan Kewirausahaan' && kelas='11 MIA'");

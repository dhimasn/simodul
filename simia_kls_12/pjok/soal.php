...
<div class="col-sm-4">
				  ...
				  <div class="panel panel-default" >
						...
						<div class="list-group">
									...
									<a href="../pjok/ipa.php" class="list-group-item active">
									...
									<a href="../bas/ipa.php" class="list-group-item ">
		...
		<table id="example1" class="table table-bordered table-striped">
									...
									<?php
										...
										$sql = mysqli_query($koneksi ,"SELECT * FROM materi WHERE tipe!='MODUL PELAJARAN' && matapel='Pendidikan Jasmani Olahraga dan Kesehatan' && kelas='12 MIA'");
										...
										echo '<tr bgcolor="#fff">
												...
												<td align="center"><a href="'.$data['file'].'">'.$data['nama_file'].'</a></td>

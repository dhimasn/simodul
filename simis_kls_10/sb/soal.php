	...
	<header>
				  ...
				  <div class="panel panel-default" >
						...
						<span class="glyphicon glyphicon-th"></span> DAFTAR MATA PELAJARAN SOSIAL
								...
								<a  href="../pab/ips.php" class="list-group-item ">
									...
									<a href="../sb/ips.php" class="list-group-item active">
		...
		<table id="example1" class="table table-bordered table-striped">
									...
									<?php
										...
										$sql = mysqli_query($koneksi ,"SELECT * FROM materi WHERE tipe!='MODUL PELAJARAN' && matapel='Seni budaya(Seni Musik)' && kelas='10 MIS' ");

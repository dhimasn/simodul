	...
	<header>
				  ...
				  <div class="panel panel-default" >
						...
						<span class="glyphicon glyphicon-th"></span> DAFTAR MATA PELAJARAN SOSIAL
								...
								<div class="list-group">
									...
									<a href="../bas/ips.php" class="list-group-item active">
		...
		<table id="example1" class="table table-bordered table-striped">
									...
									<?php
										...
										$sql = mysqli_query($koneksi ,"SELECT * FROM materi WHERE tipe!='MODUL PELAJARAN' && matapel='Bahasa Asing dan sastra Inggris' && kelas='11 MIS' ");

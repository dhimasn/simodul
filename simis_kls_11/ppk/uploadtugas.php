			...
			if(isset($_POST['upload'])){
				...
				if(in_array($ext, $allowed_ext) === true){
					if($file_size < 1024 * (1024 * 1024)){
							$lokasi = '../../file_tugas/ppk/'.$subject.' '.$nama.' '.$nis.'.'.$ext;
            ...
            <p>
             ...
             <div class="form-group form-group-sm">
											...
											<div class="form-group form-group-sm">
			   								...
			   								<input type="reset" name="RESET" class="btn btn-danger btn-sm" value="RESET" >  
				    						<input type="submit" name="UNGGAH" class="btn btn-warning btn-sm" value="UNGGAH"/>
												</div>
											</div>
										</form>
            							</p>

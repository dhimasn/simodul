	...
	<header>
				  ...
				  <div class="panel panel-default" >
						...
						<span class="glyphicon glyphicon-th"></span> DAFTAR MATA PELAJARAN SOSIAL
								...
								<div class="list-group">
									...
									<a href="../pjok/ips.php" class="list-group-item active">
										<span class="glyphicon glyphicon-file"></span> Pendidikan jasmani olahraga dan kesehatan
									</a>
									<a href="../pbk/ips.php" class="list-group-item">
		...
		<table id="example1" class="table table-bordered table-striped">
									...
									<?php
										...
										$sql = mysqli_query($koneksi ,"SELECT * FROM materi WHERE tipe!='MODUL PELAJARAN' && matapel='Pendidikan Jasmani Olahraga dan Kesehatan' && kelas='12 MIS' ");

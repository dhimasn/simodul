...
<?php
	...
	include ('../../config.php');
	$id = $_GET['id'];
	$sql = mysqli_query($koneksi ,"SELECT * FROM tugas WHERE id = '$id' ");
...
<html lang="en">
  <head>
   ...
   <form class="form-horizontal"  method="post" enctype="multipart/form-data" action="">
			...
			<div class="form-group form-group-sm">
			<label class="col-sm-6 control-label pad-right-zero">Deadline :</label>
			<div class="col-sm-5">
			...
			<div class="form-group form-group-sm">
			<label class="col-sm-6 control-label pad-right-zero">Info tugas :</label>
			<div class="col-sm-5">
					<?php echo $data['info']?>
			</div>
			</div>
			...
			<a href="tugas.php" class="btn btn-success btn-sm" role="button">KEMBALI</a>
			<a href="uploadtugas.php?id=<?php echo $data['id']?>" class="btn btn-danger btn-sm" role="button">UNGGAH TUGAS</a>
			</div>
			</div>
		</form>
       					 </div>
